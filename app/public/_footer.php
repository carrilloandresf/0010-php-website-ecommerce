  ...
  <footer class="bg-navy text-white">
    ...
    <div class="max-w-5xl mx-auto px-5 pt-10 pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <!-- Columna 2: El marketplace (páginas SEO) -->
      <div>
        ...
        <ul class="space-y-2 text-white/55 text-xs">
          ...
          <li><a href="/"             class="hover:text-white transition hover:underline">Ver el catálogo</a></li>
      ...
      <div>
        ...
        <p class="text-white/55 text-xs leading-relaxed mb-4">
          Publícalos aquí y llega a miles de colombianos. Gratis. Sin comisiones. Sin intermediarios.
        </p>
